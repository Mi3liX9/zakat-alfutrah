...
export const Calculator: React.FC = () => {
  ...
  return (
    <form className="grid grid-rows-4 grid-cols-8">
      <fieldset className="col-start-2 col-end-9 row-start-1 row-end-5 grid grid-rows-4 grid-cols-4 bg-sky-950 text-center text-sky-500 rounded-r-2xl">
        <label
          htmlFor="members"
      ...
      <fieldset className="col-start-1 col-end-3 row-start-2 row-end-4 flex flex-col justify-evenly aspect-square bg-white rounded-2xl shadow-md">
